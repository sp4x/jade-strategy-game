...
public class MilitaryAI extends GoalBasedAI {
	...
	private void manageFighting() {
		...
		if(goalLevels.getAttack() == GoalPriority.HIGH){
			// Se il battaglone non Ë pronto c'Ë 1/3 di possbilit‡ di attaccare comunque
	...
	public void onEnemySighting(EnemySighting e) {
		...
		//TODO: Un numero che che rappresneti il livelo dovrebbe essere messo altrove, visto che sar√† utilizzato spesso
		int defence = 1;
		if(goalLevels.getDefence().equals(GoalPriority.LOW))
			defence = 1;
